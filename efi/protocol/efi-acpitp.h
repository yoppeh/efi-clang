...
typedef EFI_STATUS (*EFI_ACPI_TABLE_INSTALL_ACPI_TABLE)(void *This, VOID *AcpiTableBuffer, UINTN AcpiTableBufferSize, UINTN *TableKey);
typedef EFI_STATUS (*EFI_ACPI_TABLE_UNINSTALL_ACPI_TABLE)(void *This, UINTN  TableKey);
